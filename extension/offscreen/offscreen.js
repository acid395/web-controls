 ...
 *
 * This pass tests one thing only: does the model load and answer at all, on
 * real hardware, through a real offscreen document. Not wired into the
 * tool-calling loop yet - that's the next step, once this is confirmed.
 *
